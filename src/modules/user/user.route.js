...
import { loginValidationSchema, registerUserValidationSchema, updateUserValidationSchema } from './user.validation.js';
...
router.put('/update/:userId', validateRequest(updateUserValidationSchema), updateUser);
